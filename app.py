...
def get_spreadsheet_object():
    ...
    if client:
        try:
            return client.open("Matriculas_NAVE_2026")
...
def setup_spreadsheet():
    ...
    if not sh:
        st.error("Planilha 'Matriculas_NAVE_2026' não encontrada!")
        st.stop()
        return None
    ...
    common_headers = [
        ...
        "ano_serie", "turno",
        "consentimento_dados",
        "raca", "genero", "escolaridade_resp1", "escolaridade_resp2",
        "qtd_pessoas_domicilio", "qtd_banheiros", "bens",
        "livros_qtd", "bolsa_familia",
        "inse_pontos", "inse_classificacao",
